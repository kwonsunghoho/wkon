...
(function () {
  ...
  var CSS = [
    ...
    '.wl-box{background:var(--surface,#fff);color:var(--text,#26221C);width:100%;max-width:440px;',
    ...
    '.wl-lede{font-size:14px;line-height:1.65;color:var(--text-muted,#736E64);margin:0 0 18px}',
    ...
    '  border:1px solid var(--border-soft,#DAD3C4);border-radius:10px;background:var(--bg2,#FBF9F5);',
    ...
    '.wl-fine{font-size:12px;line-height:1.6;color:var(--text-muted,#736E64);margin:0 0 16px 32px}',
