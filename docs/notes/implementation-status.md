...
| answer-program | `2026-07-30b` (프로브 sessions_table:true · questions 99 · programs 1 — 2026-08-15 실측) — **레포는 `2026-08-16b`(소재 창고 개명 문구 + `card_from_chat` 소재 발굴 연동), owner 재배포 필요.** 재배포 확인: 프로브 features 에 `card_from_chat` | 프로브 있음 — 상세는 `docs/monc-answer-program/implementation-status.md` |
