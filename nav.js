...
(function () {
  ...
  /* 연구실 드롭다운(2026-07-31 오너 확정) — 상단 탭 '연구실'은 카테고리(허브)고,
     목차는 '연구실'(lab.html) 하나만 둔다(오너 — "탭에 연구실은 연구실만 남겨야 될 거
     아니야" · 앞서 넣었던 '연구진 소개'는 제거 — 연구진은 허브 하단 카드로 접근).
     하위 페이지(자료실·영상관·기출문제 등)가 생기면 이 배열에 한 줄씩 추가한다.
     ⚠️ 승준노트·챌린지 목차의 허브 링크('한눈에')는 오너가 뺐으므로 되살리지 말 것 —
        허브 링크를 목차 안에 두는 건 연구실 한 곳이다. */
  var LAB_HUB = 'lab.html';
  var LAB_SUB = [
    ['lab.html', '연구실', '자료실·영상관·기출문제·채용 캘린더']
  ];
