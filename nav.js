...
(function () {
  ...
  /* 연구실 드롭다운(2026-07-31 오너 확정 — '연구진' 단독 항목 대신 연구실 하위로).
     ...
     ⚠️ 첫 줄의 허브 링크는 연구실만 둔다(오너 — "하위탭이 연구실이 없네? 연구실을 클릭하면
        연구실만 나와야지"): 하위가 1개뿐이라 허브 가는 길이 목차에 안 보였다. 승준노트·챌린지의
        '한눈에'는 오너가 뺐으므로(두 번 누르면 이동) 거기에 다시 넣지 말 것. */
  var LAB_HUB = 'lab.html';
  var LAB_SUB = [
    ['lab.html', '연구실 한눈에', '자료실·영상관·기출문제·연구진'],
