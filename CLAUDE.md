...
- **UI 원칙 14개와 현행 팔레트 상세 = `docs/design-principles.md`**(2026-08-02 재검토로 구 '9대 원칙'을 대체). 요지: 활자 12px+·**입력칸 16px+** · 터치 44px+·**간격 8px** · 대비 4.5:1·**경계선 3:1** · 라운드·계층·여백·그룹핑 · **상태를 단정하지 않기** · **결정 화면에 값·버튼·근거** · **전송량 예산** · **포커스와 키보드**.
