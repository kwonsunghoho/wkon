...
- **⑤ 마무리 CTA**: ①을 받아 닫는 수미상관("혼자 준비하더라도, 혼자가 아니도록.") + '몬크 시작하기'→apply.html + '이미 회원이라면 로그인'. **⚠️ ①의 문장과 한 쌍이라 한쪽만 고치면 서사의 처음과 끝이 어긋난다.** ⚠️ 오너 지시로 목업의 **MONC PROMISE 3단 목록(01 오늘 할 일을 찾고 / 02 직접 연습하고 / 03 다시 나아가도록)은 넣지 않는다** — 다시 넣지 말 것.
