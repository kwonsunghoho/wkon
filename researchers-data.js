/* ══════════════════════════════════════════════════════════════════════════
   ...
   쓰는 곳: researchers.html(연구진 페이지) · lab.html(허브 '연구진' 카드의
   얼굴 6개 + 인원수 — ②안 콘솔 확정 때 추가). 허브의 연구진 '이력 임베드'는
   2026-07-31 오너 지시(허브 = 카드 두 장)로 빠졌다 — 카드가 researchers.html 로
   연결하고, 카드 안에는 얼굴·인원수만 이 파일에서 그린다.
...
window.MONC_RESEARCHERS = [
  {
    ...
    key:[
      ...
      '<strong>국토교통부 주최 2026 항공산업 커리어 엑스포</strong> 영상면접·자소서&이력서 전문 컨설턴트',
      '<strong>국토교통부 주최 2023·2025 항공잡페어</strong> 취업컨설턴트',
  ...
  },
  {
    ...
    key:[
      '외항사 FSC·국내 LCC <strong>객실승무원 9년차</strong> (동방항공 비즈니스 클래스 · 에어서울 부사무장 · 트리니티항공 경력직 · 스쿠트항공 최합)',
      '<strong>국토교통부 주최 2026 항공산업 커리어 엑스포</strong> 영상면접·자소서&이력서 전문 컨설턴트',
      '<strong>국토교통부 주최 2025 항공잡페어</strong> 취업컨설턴트 · <strong>한국항공대 주관 2025 활주로 일자리박람회</strong> 취업컨설턴트',
