...
(function () {
  ...
  var CSS = [
    ...
    '  background:var(--bg2,#FBF9F5);border:1px solid var(--border-soft,#DAD3C4);',
    '  border-radius:12px;cursor:pointer;font:inherit;text-align:left;color:var(--text,#26221C)}',
    ...
    '.qf-tease.compact .qf-tease-t{font-size:12.5px;font-weight:700;color:var(--text-muted,#736E64)}',
    ...
    '.qf-box{background:var(--surface,#fff);color:var(--text,#26221C);width:100%;max-width:460px;',
    ...
    '.qf-lede{font-size:14px;line-height:1.65;color:var(--text-muted,#736E64);margin:0 0 14px;word-break:keep-all}',
    '.qf-ta{width:100%;box-sizing:border-box;font:inherit;font-size:16px;line-height:1.6;',
    '  padding:12px 13px;border:1px solid var(--border-soft,#DAD3C4);border-radius:12px;',
    '  background:var(--bg2,#FBF9F5);color:inherit;min-height:110px;resize:vertical}',
    '.qf-ta:focus{outline:2px solid var(--accent-dark,#142C52);outline-offset:1px;border-color:transparent}',
    '.qf-cnt{text-align:right;font-size:12px;color:var(--text-muted,#736E64);margin:6px 0 0}',
    /* ⚠️ 수집 고지 — 12px 하한. 지우지 말 것 */
    '.qf-fine{font-size:12px;line-height:1.6;color:var(--text-muted,#736E64);margin:10px 0 14px}',
    ...
    '  border:none;background:none;color:var(--text-muted,#736E64);cursor:pointer;min-height:44px}',
    '.qf-msg{font-size:13.5px;line-height:1.6;margin:10px 0 0;text-align:center}',
    '.qf-msg.err{color:#9E3B34;font-weight:700}',
    /* 결과 — '지금 → 이렇게' */
    '.qf-lbl{font-size:12px;font-weight:800;letter-spacing:.08em;color:var(--text-muted,#736E64);margin:14px 0 5px}',
    '.qf-lbl.fix{color:var(--accent-ink,#1B3A6B)}',
    '.qf-was{font-size:14px;line-height:1.65;color:var(--text-muted,#736E64);background:var(--bg2,#FBF9F5);',
    ...
    '.qf-spots li{font-size:13px;line-height:1.6;color:var(--text,#26221C);margin-top:6px}',
    '.qf-spots b{color:var(--accent-ink,#1B3A6B)}',
    '.qf-left{font-size:12.5px;color:var(--text-muted,#736E64);text-align:center;margin:14px 0 0}',
    ...
    '.qf-links{margin-top:14px;padding-top:12px;border-top:1px dashed var(--border-soft,#DAD3C4)}',
