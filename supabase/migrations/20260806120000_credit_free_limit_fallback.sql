...
-- =============================================================================
-- ⚠️⚠️ 실행 보류 — 2026-08-06 오너 결정: "일단 둘게, 비용관련된건 나중에 한번에 대대적으로 잡자".
--   임의로 실행하지 말 것. 비용 일괄 점검 때 다른 과금 항목과 함께 본다
--   (목록: docs/notes/implementation-status.md '비용 일괄 점검' 절).
--
-- 실행할 때: Supabase 대시보드 > SQL Editor 에 붙여넣고 Run. idempotent — 재실행 안전.
